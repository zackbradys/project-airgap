...
resource "aws_iam_role_policy" "aws_iam_policy" {
  name       = "${var.prefix}-iam-policy"
  role       = aws_iam_role.aws_iam_role.id
  depends_on = [aws_iam_role.aws_iam_role]
...
resource "aws_iam_instance_profile" "aws_iam_profile" {
  ...
  depends_on = [aws_iam_role_policy.aws_iam_policy]
}
